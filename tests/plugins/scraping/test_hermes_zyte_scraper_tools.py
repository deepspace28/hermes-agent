...
PLUGIN_ROOT = Path(__file__).resolve().parents[3] / "plugins" / "scraping" / "hermes-zyte-scraper"
_PKG = "hermes_zyte_scraper_testpkg"
...
def _load_module(name: str, filename: str):
    _ensure_package()
    module_path = PLUGIN_ROOT / filename
...
helpers = _load_module("zyte_helpers", "zyte_helpers.py")
operations = _load_module("operations", "operations.py")
